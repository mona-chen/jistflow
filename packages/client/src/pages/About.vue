<template>
	<StickyContainer>
		...
		<Spacer :content-max="600" :margin-min="20">
			<swiper
				:round-lengths="true"
				:touch-angle="25"
				:threshold="10"
			...
			>
				<swiper-slide>
					<div class="_formRoot">
						...
						<FormSection>
							<KeyValue class="_formBlock" :copy="version">
				...
				<swiper-slide>
					<InstanceStats :chart-limit="500" :detailed="true" />
				</swiper-slide>
				<swiper-slide>
					<XFederation />
				</swiper-slide>
...
import XEmojis from "./AboutEmojis.vue";
import XFederation from "./AboutFederation.vue";
