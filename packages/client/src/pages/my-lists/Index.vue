<template>
	<StickyContainer>
		...
		<Spacer :content-max="700">
			<div class="qkcjvfiv">
				<Info class="_gap" :icon="'list-bullets'" :card="true">
					<p>{{ i18n.ts.listsDesc }}</p>
					<Button primary class="add" @click="create"
						><i class="ph-plus ph-bold ph-lg"></i>
						{{ i18n.ts.createList }}</Button
					>
				</Info>
				...
				>
					...
					>
						...
						<Avatars :user-ids="list.userIds" />
					</A>
					<Button @click="deleteAll"
						><i class="ph-trash ph-bold ph-lg"></i>
						{{ i18n.ts.deleteAll }}</Button
					>
				</Pagination>
			</div>
		</Spacer>
