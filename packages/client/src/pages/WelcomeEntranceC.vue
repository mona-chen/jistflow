<template>
	<div v-if="meta" class="rsqzvsbo">
		<div class="top">
			<FeaturedPhotos class="bg" />
			<div class="fade"></div>
			<div class="emojis">
				<Emoji :normal="true" :no-style="true" emoji="👍" />
				<Emoji :normal="true" :no-style="true" emoji="❤" />
				<Emoji :normal="true" :no-style="true" emoji="😆" />
				<Emoji :normal="true" :no-style="true" emoji="🎉" />
				<Emoji :normal="true" :no-style="true" emoji="🍮" />
			...
			<div class="main">
				...
				<div class="form _panel">
					...
					<div class="fg">
						...
						<div class="action">
							<Button inline gradate @click="signup()">{{
								i18n.ts.signup
							}}</Button>
							<Button inline @click="signin()">{{
								i18n.ts.login
							}}</Button>
						</div>
				...
				<nav class="nav">
					<A to="/announcements">{{ i18n.ts.announcements }}</A>
					<A to="/explore">{{ i18n.ts.explore }}</A>
					<A to="/channels">{{ i18n.ts.channel }}</A>
					<A to="/featured">{{ i18n.ts.featured }}</A>
				</nav>
			</div>
		</div>
	</div>
...
import XTimeline from "./WelcomeTimeline.vue";
import XSigninDialog from "@/components/SigninDialog.vue";
import XSignupDialog from "@/components/SignupDialog.vue";
