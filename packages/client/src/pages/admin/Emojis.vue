			...
			<Spacer :content-max="900">
				<div class="ogwlenmc">
					<div v-if="tab === 'local'" class="local">
						<Input v-model="query" :debounce="true" type="search">
							<template #prefix
								><i
						...
						<Switch v-model="selectMode" style="margin: 8px 0">
						...
						<div
							...
							"
						>
							<Button inline @click="selectAll"
								>Select all</Button
							>
							<Button inline @click="setCategoryBulk"
								>Set category</Button
							>
							<Button inline @click="addTagBulk">Add tag</Button>
							<Button inline @click="removeTagBulk"
								>Remove tag</Button
							>
							<Button inline @click="setTagBulk">Set tag</Button>
							<Button inline @click="setLicenseBulk"
								>Set license</Button
							>
							<Button inline danger @click="delBulk"
								>Delete</Button
							>
						</div>
						<Pagination
					...
					<div v-else-if="tab === 'remote'" class="remote">
						<FormSplit>
							...
							<Input v-model="host" :debounce="true">
								<template #label>{{ i18n.ts.host }}</template>
							</Input>
						</FormSplit>
						<Pagination :pagination="remotePagination">
							<template #empty
								><span>{{
									i18n.ts.noCustomEmojis
								}}</span></template
...
const emojisPaginationComponent = ref<InstanceType<typeof Pagination>>();
...
const edit = (emoji) => {
	os.popup(
		defineAsyncComponent(() => import("./EmojiEditDialog.vue")),
		{
			emoji: emoji,
		},
		{
