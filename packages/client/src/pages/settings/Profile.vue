<template>
	<div class="_formRoot">
		<div v-if="saveButton == true">
			<Button primary @click="save">{{ i18n.ts.save }}</Button>
		</div>
		<br />
		<div
			class="llvierxe"
		...
		>
			<div class="avatar">
				...
				<Button
					...
					class="avatarEdit"
					@click="changeAvatar"
					>{{ i18n.ts._profile.changeAvatar }}</Button
				>
			</div>
			<Button primary rounded class="bannerEdit" @click="changeBanner">{{
			...
			<FormFolder>
				...
				<div class="_formRoot">
					...
					<Button
						...
						{{ i18n.ts.add }}</Button
					>
					<Button inline primary @click="saveFields"
