<template>
	<div class="_formRoot">
		...
		<FormSection>
			...
			<Pagination :pagination="pagination" disable-auto-load>
					...
					<div>
						...
						>
							<header>
								...
								<Time :time="item.createdAt" class="time" />
							</header>
						</div>
					</div>
				</template>
		...
		<FormSection>
			<FormSlot>
				<Button danger @click="regenerateToken"
					><i class="ph-arrows-clockwise ph-bold ph-lg"></i>
					{{ i18n.ts.regenerateLoginToken }}</Button
				>
				<template #caption>{{
