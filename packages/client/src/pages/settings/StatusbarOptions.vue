<template>
	<div class="_formRoot">
		...
		<Input v-model="statusbar.name" manual-save class="_formBlock">
			<template #label>{{ i18n.ts.label }}</template>
		</Input>

		<Switch v-model="statusbar.black" class="_formBlock">
		...
		<template v-if="statusbar.type === 'rss'">
			...
			<Switch v-model="statusbar.props.shuffle" class="_formBlock">
			...
			<Switch v-model="statusbar.props.marqueeReverse" class="_formBlock">
		...
		<template v-else-if="statusbar.type === 'federation'">
			...
			<Switch v-model="statusbar.props.colored" class="_formBlock">
