<template>
	<div class="_formRoot">
		...
		>
		<FormSection>
			<ForFormButtonmLink class="_formBlock" @click="readAllNotifications"
		...
		<FormSection>
			...
			<div class="_gaps_m">
				<PushNotificationAllowButton ref="allowButton" />
				<Switch
...
let allowButton =
	$shallowRef<InstanceType<typeof PushNotificationAllowButton>>();
...
function configure() {
	...
	os.popup(
		defineAsyncComponent(
			() => import("@/components/NotificationSettingWindow.vue"),
		),
		{
			includingTypes,
