<template>
	<div class="_gaps_m">
		...
		<div class="buttons">
			<Button inline @click="addItem"
				><i class="ph-plus ph-bold ph-lg"></i>
				{{ i18n.ts.addItem }}</Button
			>
			<Button inline danger @click="reset"
				><i class="ph-arrow-clockwise ph-bold ph-lg"></i>
				{{ i18n.ts.default }}</Button
			>
			<Button inline primary class="save" @click="save"
		...
		<FormRadios v-model="menuDisplay">
			...
			<!-- <Radio v-model="menuDisplay" value="hide" disabled>{{ i18n.ts._menuDisplay.hide }}</Radio>-->
