<template>
	<Spacer :content-max="narrow ? 800 : 1100">
		<div
			ref="rootEl"
			v-size="{ max: [500] }"
			class="ftskorzw"
...
import XUserTimeline from "./IndexTimeline.vue";
import type * as misskey from "iceshrimp-js";
import XNote from "@/components/Note.vue";
import FollowButton from "@/components/FollowButton.vue";
import RemoteCaution from "@/components/RemoteCaution.vue";
import Info from "@/components/Info.vue";
import Moved from "@/components/Moved.vue";
...
const XPhotos = defineAsyncComponent(() => import("./IndexPhotos.vue"));
const XActivity = defineAsyncComponent(() => import("./IndexActivity.vue"));
