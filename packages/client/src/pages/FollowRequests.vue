<template>
	<StickyContainer>
		...
		<Spacer :content-max="800">
			<Pagination ref="paginationComponent" :pagination="pagination">
				<template #empty>
					<div class="_fullinfo">
						<img
				...
				<template #default="{ items }">
					<Info v-if="$i?.isLocked === false" warn class="info"
...
const paginationComponent = ref<InstanceType<typeof Pagination>>();
