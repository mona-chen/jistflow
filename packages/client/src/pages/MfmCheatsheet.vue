				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_mention"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				</div>
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_hashtag"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_emoji"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_small"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_quote"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_center"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_inlineCode"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_blockCode"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_inlineMath"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_blockMath"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
		...
		<div class="section _block">
			...
			<div class="content">
				...
				<div class="preview">
					...
					<Textarea v-model="preview_search"><template #label>MFM</template></Textarea>
				</div>
			</div>
		</div>
		-->
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_jelly"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_bounce"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_shake"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_twitch"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_rainbow"
								><template #label>MFM</template></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_sparkle"
								><span>MFM</span></Textarea
							>
						</div>
					</div>
				</div>
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_rotate"
								><span>MFM</span></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_position"
								><span>MFM</span></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_scale"
								><span>MFM</span></Textarea
							>
						</div>
					</div>
				...
				<div class="section _block">
					...
					<div class="content">
						...
						<div class="preview">
							...
							<Textarea v-model="preview_plain"
								><span>MFM</span></Textarea
							>
						</div>
					</div>
