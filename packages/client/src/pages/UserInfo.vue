			...
			<FormSuspense :p="init">
				<div v-if="tab === 'overview'" class="_formRoot">
					...
					<div class="_formBlock">
						<KeyValue :copy="user.id" oneline style="margin: 1em 0">
						...
						<!-- 要る？
					<KeyValue v-if="ips.length > 0" :copy="user.id" oneline style="margin: 1em 0;">
					...
					-->
						...
						<KeyValue v-if="info" oneline style="margin: 1em 0">
							<template #key>{{
					...
					<FormSection>
						...
						<div class="_formBlock">
							...
							<KeyValue v-else oneline style="margin: 1em 0">
								<template #key>{{
									i18n.ts.instanceInfo
								}}</template>
							...
							<KeyValue v-if="ap" oneline style="margin: 1em 0">
						...
						<FormFolder class="_formBlock">
							...
							<ObjectView v-if="ap" tall :value="ap">
							</ObjectView>
						</FormFolder>
					</FormSection>
				</div>
				...
				<div v-else-if="tab === 'raw'" class="_formRoot">
					<ObjectView v-if="info && $i.isAdmin" tall :value="info">
					</ObjectView>

					<ObjectView tall :value="user"> </ObjectView>
				</div>
			</FormSuspense>
		</Spacer>
	</StickyContainer>
