		...
		<Spacer :content-max="700">
			<div class="jqqmcavi">
				<Button
					...
					{{ i18n.ts._pages.viewPage }}</Button
				>
				<Button
					v-if="!readonly"
					inline
					...
					{{ i18n.ts.save }}</Button
				>
				<Button v-if="pageId" inline class="button" @click="duplicate"
					><i class="ph-clipboard-text ph-bold ph-lg"></i>
					{{ i18n.ts.duplicate }}</Button
				>
				<Button
			...
			<div v-if="tab === 'settings'">
				<div class="_formRoot">
					<Input v-model="title" class="_formBlock">
						<template #label>{{ i18n.ts._pages.title }}</template>
					</Input>

					<Input v-model="summary" class="_formBlock">
					...
					<Switch v-model="isPublic" class="_formBlock">{{
						i18n.ts.public
					}}</Switch>
					<Switch v-model="alignCenter" class="_formBlock">{{
						i18n.ts._pages.alignCenter
					}}</Switch>

					<Select v-model="font" class="_formBlock">
					...
					<Switch v-model="hideTitleWhenPinned" class="_formBlock"
					...
					<div class="eyeCatch">
						<Button
							...
							{{ i18n.ts._pages.eyeCatchingImageSet }}</Button
						>
			...
			<div v-else-if="tab === 'contents'">
				<div>
					...
					<Button v-if="!readonly" @click="add()"
						><i class="ph-plus ph-bold ph-lg"></i
					></Button>
				</div>
			</div>
			...
			<div v-else-if="tab === 'variables'">
				<div class="qmuvgica">
					...
					<Button v-if="!readonly" class="add" @click="addVariable()"
						><i class="ph-plus ph-bold ph-lg"></i
					></Button>
				</div>
			</div>
			...
			<div v-else-if="tab === 'script'">
				<div>
					<Textarea v-model="script" class="_code" />
				</div>
			</div>
		</Spacer>
	</StickyContainer>
...
import XVariable from "./ScriptBlock.vue";
