<template>
	<StickyContainer>
		...
		<Spacer :content-max="1000" :margin-min="16" :margin-max="32">
			<div class="_root">
				<transition
				...
				>
					<div v-if="post" class="rkxwuolj">
						...
						<div class="body _block">
							...
							<div class="info">
								...
								<Time :time="post.createdAt" mode="detail" />
							</div>
							<div class="actions">
								<div class="like">
									<Button
					...
					<Error v-else-if="error" @retry="fetch()" />
					<Loading v-else />
				</transition>
			</div>
		</Spacer>
...
import GalleryPostPreview from "@/components/GalleryPostPreview.vue";
