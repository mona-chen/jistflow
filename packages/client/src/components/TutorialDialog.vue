			...
			<div class="_section">
				<div class="tbkwesmv">
					<div class="_footer navigation">
						...
						>
						<Button v-else class="ok" primary @click="tutorial++"
							><i class="ph-check ph-bold ph-lg"></i>
							{{ i18n.ts.next }}</Button
						>
					</div>
					<Transition name="fade">
						...
						>
							...
							<XFeaturedUsers />
							<br />
							<Button class="ok" primary @click="tutorial++"
								><i class="ph-check ph-bold ph-lg"></i>
								{{ i18n.ts.next }}</Button
							>
						</section>
						...
						>
							...
							<I18n :src="i18n.ts._tutorial.step4_2" tag="div">
								<template #introduction>
									<A class="_link" to="/tags/introduction"
										>#introduction</A
									>
								</template>
							</I18n>
...
import XFeaturedUsers from "@/pages/ExploreUsers.vue";
import XPostForm from "@/components/PostForm.vue";
import Sparkle from "@/components/Sparkle.vue";
import PushNotificationAllowButton from "@/components/PushNotificationAllowButton.vue";
