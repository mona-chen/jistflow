		...
		<div class="body">
			...
			<nav class="middle">
				...
				<template v-for="item in menu">
					...
					<component
						:is="navbarItemDef[item].to ? 'A' : 'button'"
						v-else-if="
							navbarItemDef[item] &&
				...
				>
					<span
						...
						"
						class="indicator"
						><i class="icon ph-circle ph-fill"></i></span
			...
			<div class="bottom">
				...
				<Avatar :user="$i" class="account"/><Acct class="text" :user="$i"/>
			</button> -->
			</div>
		</div>
	</header>
...
function more(ev: MouseEvent) {
	os.popup(
		defineAsyncComponent(() => import("@/components/LaunchPad.vue")),
		{
