...
const XRss = defineAsyncComponent(() => import("./StatusbarRss.vue"));
const XFederation = defineAsyncComponent(
	() => import("./StatusbarFederation.vue"),
);
const XUserList = defineAsyncComponent(() => import("./StatusbarUserList.vue"));
</script>
