<template>
	...
	>
		...
		<StickyContainer class="contents">
			<template #header>
...
import XDrawerMenu from "@/ui/common/NavbarMobile.vue";
...
const XWidgets = defineAsyncComponent(() => import("./UniversalWidgets.vue"));
const XStatusBars = defineAsyncComponent(
	() => import("@/ui/common/Statusbars.vue"),
);
