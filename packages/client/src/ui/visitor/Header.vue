<template>
	<div class="sqxihjet">
		<div v-if="narrow === false" class="wide">
			<div class="content">
				<A to="/" class="link" active-class="active"
				...
				<!-- <A
					...
					>{{ i18n.ts.timeline }}</A
				> -->
				<A to="/explore" class="link" active-class="active"
					><i class="ph-compass ph-bold ph-lg icon"></i
					>{{ i18n.ts.explore }}</A
				>
				<A to="/channels" class="link" active-class="active"
					><i class="ph-television ph-bold ph-lg icon"></i
					>{{ i18n.ts.channel }}</A
				>
				<A to="/pages" class="link" active-class="active"
					><i class="ph-file-text ph-bold ph-lg icon"></i
					>{{ i18n.ts.pages }}</A
				>
				<A to="/gallery" class="link" active-class="active"
